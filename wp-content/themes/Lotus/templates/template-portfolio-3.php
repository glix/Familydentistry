						...
						?>
											...
											<?php
												...
												foreach($page_photo_arr as $key => $portfolio_item)
												{
													...
													{	
														...
														{
															$line_break = '<br class="clear"/><br /><br/>';
														}
														else
														{
											...
											?>
															<div class="one_third<?php echo $last_class?>">
																<a title="<?php echo $portfolio_item->post_title?>" href="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]?>&h=160&w=260&zc=1" class="one_third_img">
																	<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]?>&h=160&w=260&zc=1" alt="" class="img_nofade"/>
																</a>
																
																<br class="clear"/><br class="clear"/>
																
																<div class="portfolio_desc">
																	<h5 class="cufon"><?php echo $portfolio_item->post_title?></h5>
																	<span>
