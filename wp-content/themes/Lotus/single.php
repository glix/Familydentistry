...
?>
<!--this is comment for dont show title-->
		...
		<div id="content_wrapper">
			...
			<div class="inner">
				...
				<div class="inner_wrapper">
					...
					</div>					<div class="sidebar_content" style="border:0">
					
<?php

	$image_thumb = '';
								
	if(has_post_thumbnail(get_the_ID(), 'medimum'))
	{
	    $image_id = get_post_thumbnail_id(get_the_ID());
	    $image_thumb = wp_get_attachment_image_src($image_id, 'medimum', true);
...
?>
						...
						<div class="post_wrapper">
							...
							?>
									...
									<a style="float:left"href="<?php echo get_bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_thumb[0]; ?>&amp;h=<?php echo $pp_blog_image_height; ?>&amp;w=<?php echo $pp_blog_image_width; ?>&amp;zc=1" title="<?php the_title(); ?>">
										<img  style="float:left"src="<?php echo get_bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_thumb[0]; ?>&amp;h=<?php echo $pp_blog_image_height; ?>&amp;w=<?php echo $pp_blog_image_width; ?>&amp;zc=1" alt="" class="img_nofade alignleft frame"/>
									</a>
							...
							?>
									<br/>
									<a style="float:left" href="<?php echo get_bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_thumb[0]; ?>&amp;h=<?php echo $pp_blog_image_height; ?>&amp;w=<?php echo $pp_blog_image_width; ?>&amp;zc=1" title="<?php the_title(); ?>">
										<img style="float:left" src="<?php echo get_bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_thumb[0]; ?>&amp;h=<?php echo $pp_blog_image_height; ?>&amp;w=<?php echo $pp_blog_image_width; ?>&amp;zc=1" alt="" class="img_nofade frame align<?php echo $post_img_align; ?>"/>
									</a>
							<?php
									}
								}
