...
?>
					...
					<div class="sidebar_content contact_form">
						<?php 
							if(!isset($hide_header) OR !$hide_header)
							{
						...
						?>
						<div class="title" style="margin-bottom:20px;margin-left:0"> <h2> <?php  the_title() ?></h2> </div>
						<form id="contact_form" method="post" action="<?php echo curPageURL(); ?>">
						    <p>
						    	<label for="your_name" style="margin-bottom:10px">Name</label>
						    ...
						    <p style="margin-top:5px" >
						    	...
						    	<textarea style="resize:none" id="message" name="message" rows="7" cols="10" style="width:94%"></textarea>
						    </p>
						   <p style="margin-top:5px">
								<input type="submit" class="btn btn-success icon-chevron-right" style="padding:5px 17px 5px 17px" Value="Submit" />
							</p>
						</form>
